...
Alicia-D SDK 是经过完全重构的机械臂控制SDK，采用清晰的分层架构设计，解决了v5.5.x版本中功能重叠、职责不清、架构混乱的问题。
...
# 新版本
from alicia_d_sdk import create_robot, SynriaRobotAPI
```
...
**注意**: 这是重构版本，与v5.5.x版本不兼容。请参考迁移指南进行升级。