...
setup(
    ...
    packages=find_packages(where="alicia_d_sdk"),
    package_dir={"": "alicia_d_sdk"},
    classifiers=[
    ...
    entry_points={
        "console_scripts": [
        "alicia-d-demo=examples.01_basic_usage:main",
        "alicia-d-advanced=examples.02_advanced_control:main",
        "alicia-d-arch=examples.03_architecture_demo:main",
        ],
    },
    keywords=[
        "robotics",
